...
})({"duIw6":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4db419a00b34dc2d";
...
},{}],"2HMh3":[function(require,module,exports) {
...
function submitClick(event) {
    ...
    let delay1 = Number(formSubmit.delay.value);
    for(let i = 1; i <= numberOfPromises; i += 1){
        ...
        delay1 += Number(formSubmit.step.value);
    }
}
function createPromise(position, delay) {
    ...
    return new Promise((resolve, reject)=>{
        setTimeout(()=>{
            if (shouldResolve) resolve(object);
            else reject(object);
        }, delay);
    });
}
...
},{}]},["duIw6","2HMh3"], "2HMh3", "parcelRequire7bc7")

//# sourceMappingURL=03-promises.0b34dc2d.js.map
