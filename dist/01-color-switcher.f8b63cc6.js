...
})({"j0dN8":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "8851a567f8b63cc6";
...
},{}],"hvLFe":[function(require,module,exports) {
const colorSwitcher = {
...
function changeBackgroundColor() {
    if (colorSwitcher.intervalId) colorSwitcher.body.style.backgroundColor = getRandomHexColor();
}
function getRandomHexColor() {
    return `#${Math.floor(Math.random() * 16777215).toString(16).padStart(6, "0")}`;
}

},{}]},["j0dN8","hvLFe"], "hvLFe", "parcelRequire7bc7")

//# sourceMappingURL=01-color-switcher.f8b63cc6.js.map
